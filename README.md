...
[![Gem Version](https://badge.fury.io/rb/devlopr.svg)](https://badge.fury.io/rb/devlopr)![workflow-badge](https://github.com/felipefalcaodevops/felipefalcaodevops.github.io/workflows/deploy/badge.svg)
...
![Felipe Falcao](https://github.com/felipefalcaodevops/felipefalcaodevops.github.io/blob/master/assets/img/screenshot.PNG?raw=true)
...
[![Deploy with ZEIT Now](https://zeit.co/button)](https://zeit.co/new/project?template=https://github.com/felipefalcaodevops/felipefalcaodevops.github.io)
[![Deploy with Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/felipefalcaodevops/felipefalcaodevops.github.io)
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/felipefalcaodevops/felipefalcaodevops.github.io)
...
![Jekyll Admin](https://github.com/felipefalcaodevops/felipefalcaodevops.github.io/blob/master/assets/img/jekyll-admin.PNG?raw=true)
...
```s
git remote -v
git remote add upstream https://github.com/felipefalcaodevops/felipefalcaodevops.github.io.git
git fetch upstream
git checkout master
...
You can contact me, if you need any help via [Email](mailto:felipegfalcao.si@gmail.com). If you like the project. Don't forget to :star: !

## Licence

The theme is available as open source under the terms of the [MIT License](https://opensource.org/licenses/MIT). You can do anything you want, including projects for your clients, as long as you mention an attribution back (credit links in footer). See the [Licence](https://github.com/felipefalcaodevops/felipefalcaodevops.github.io/blob/master/LICENSE) file
